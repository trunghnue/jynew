Talk(0, "Long cô nương, cổ mộ tông của ngươi thật sự là kỳ lạ, sống trong cổ mộ này nhiều năm thật đáng sợ. Ai đã xây dựng ngôi mộ cổ này?", "talkname0", 1);
Talk(59, "Ngôi mộ cổ này được xây dựng bởi Wang Chongyang, người sáng lập giáo phái Tuyền Chân, và còn được gọi là Lăng mộ của xác sống.", "talkname59", 0);
Talk(0, "Nếu ngươi là người của phái Toàn Chân, tại sao lại không phải là người của Mộ phái?", "talkname0", 1);
Talk(59, "Bởi vì Vương Trùng Dương không thể đánh bại sư phụ Lâm Triều Anh của ta nên đã từ bỏ ngôi mộ cổ này. Từ đó trở đi, ta, Cổ Mộ Giáo, sống ở đây.", "talkname59", 0);
Talk(0, "Hóa ra vẫn còn những ám chỉ này.", "talkname0", 1);
