Talk(1, "Em trai, khi em đến thăm lần nữa, em có phát triển được võ thuật cao cấp hơn không? Hồ Mâu Hầu dạy.", "talkname1", 0);
...
::label0::
    ...
    if TryBattle(0) == false then goto label1 end;
        LightScence();
        Talk(0, "Kiếm pháp nổi tiếng thế giới của Hồ gia chỉ ở mức tầm thường, trong thiên hạ đồn thổi có lẽ là cường điệu quá mức.", "talkname0", 1);
        ...
        Talk(1, "Vâng, hãy cạnh tranh lại khi tôi tìm thấy hướng dẫn sử dụng thanh kiếm bị mất!", "talkname1", 0);
