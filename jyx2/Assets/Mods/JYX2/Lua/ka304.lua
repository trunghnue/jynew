...
Talk(0, "Để làm điều gì đó, làm điều gì đó?", "talkname0", 1);
Talk(29, "Việc ta Điền Bá Quang có thể làm được tất nhiên là việc của thần linh. Thật tuyệt khi có một chiếc giường lớn như vậy và có thể đụ năm sáu cô gái cùng một lúc. Lát nữa tôi sẽ đi bắt vài cô gái xinh đẹp, bạn có muốn cùng nhau vui vẻ không?", "talkname29", 0);
