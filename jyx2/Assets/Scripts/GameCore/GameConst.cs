...
public class GameConst
{
    ...
    public static Dictionary<string, PropertyItem> ProItemDic = new Dictionary<string, PropertyItem>()
    {
        ...
        //---------------------------------------------------------------------------
        ["0"] = new PropertyItem(0, "MpType", "Thuộc tính nội lực".GetContent(nameof(GameConst)), (int)Jyx2_MpType.Yang, (int)Jyx2_MpType.Yin),
        ["1"] = new PropertyItem(1, "MaxMp", "Nội lực".GetContent(nameof(GameConst)), 40, 30),//创角用到 特殊
        ["2"] = new PropertyItem(2, "Attack", "Công".GetContent(nameof(GameConst)), 30, 20),//创角用到 特殊
        ["3"] = new PropertyItem(3, "Qinggong", "Khinh công".GetContent(nameof(GameConst)), 30, 20),
        ["4"] = new PropertyItem(4, "Defence", "Thủ".GetContent(nameof(GameConst)), 30, 20),
        ["5"] = new PropertyItem(5, "MaxHp", "Mạng".GetContent(nameof(GameConst)), 50, 30),//创角用到 特殊
        ["6"] = new PropertyItem(6, "Heal", "Heal".GetContent(nameof(GameConst)), 30, 20),
        ["7"] = new PropertyItem(7, "UsePoison", "Đầu độc".GetContent(nameof(GameConst)), 30, 20),
        ["8"] = new PropertyItem(8, "DePoison", "Giải độc".GetContent(nameof(GameConst)), 30, 20),
        ["9"] = new PropertyItem(9, "Quanzhang", "Quyền bàn tay".GetContent(nameof(GameConst)), 30, 20),
        ["10"] = new PropertyItem(10, "Yujian", "Kiếm thuật".GetContent(nameof(GameConst)), 30, 20),
        ["11"] = new PropertyItem(11, "Shuadao", "Đao thuật".GetContent(nameof(GameConst)), 30, 20),
        ["12"] = new PropertyItem(12, "Anqi", "Vũ khí ẩn".GetContent(nameof(GameConst)), 30, 20),
        //-------以上自动生成
        
        ["13"] = new PropertyItem(13, "Hp", "Hp".GetContent(nameof(GameConst)), 30, 20),
        ["14"] = new PropertyItem(14, "Tili", "Thể lực".GetContent(nameof(GameConst)), 30, 20),
        ["15"] = new PropertyItem(15, "Mp", "Nội lực".GetContent(nameof(GameConst)), 40, 30),
        ["16"] = new PropertyItem(16, "MaxHp", "Max Hp".GetContent(nameof(GameConst)), 50, 30),
        ["17"] = new PropertyItem(17, "MaxMp", "Nội lực max".GetContent(nameof(GameConst)), 40, 30),
        ["18"] = new PropertyItem(18, "Attack", "Công".GetContent(nameof(GameConst)), 30, 20),
        ["19"] = new PropertyItem(19, "AntiPoison", "Chống độc".GetContent(nameof(GameConst)), 30, 20),
        ["20"] = new PropertyItem(20, "Qimen", "Đặc biệt".GetContent(nameof(GameConst)), 30, 20),
        ["21"] = new PropertyItem(21, "Wuxuechangshi", "Võ thuật học".GetContent(nameof(GameConst)), 30, 20),
        ["22"] = new PropertyItem(22, "Pinde", "Đạo đức".GetContent(nameof(GameConst)), 30, 20),
        ["23"] = new PropertyItem(23, "AttackPoison", "Kung Fu độc".GetContent(nameof(GameConst)), 30, 20),
        ["24"] = new PropertyItem(24, "Zuoyouhubo", "Đối đầu".GetContent(nameof(GameConst)), 30, 20),
        ["25"] = new PropertyItem(25, "IQ", "IQ".GetContent(nameof(GameConst)), 100, 30),
        ["26"] = new PropertyItem(26, "Poison", "Ngộ độc".GetContent(nameof(GameConst)), 30, 20),
